...
from model.Net import BasicBlock, Net
...
parser.add_argument('--root', type=str, default='./02-论文复现/2.1Resnet/data')
...
# 模型初始化
model = Net(BasicBlock, [3, 4, 6, 3], num_classes=num_classes)
...
# TensorBoard可视化
log_dir = './02-论文复现/2.1Resnet/runs'  # 日志目录
